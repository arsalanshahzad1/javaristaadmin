  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        {activeTab === 'paths' ? (
          <button type="button" onClick={() => { setPathModal(null); setIsPathModalOpen(true); }} className="inline-flex items-center gap-2 rounded-lg bg-[#D62B2B] px-4 py-2 text-sm font-medium text-white hover:bg-[#B92323]">
            <Plus size={16} />
            New Path
          </button>
        ) : (
                ...
                <div key={path._id} className="rounded-xl border border-[#2A2A2A] bg-[#141414] p-4 flex flex-col gap-3">
                  ...
                  <div className="flex items-center justify-between pt-1 border-t border-[#2A2A2A]">
                    ...
                    <div className="flex gap-1.5">
                      <button type="button" onClick={() => { setPathModal(path); setIsPathModalOpen(true); }} className="inline-flex items-center gap-1 rounded-lg border border-[#333] px-2.5 py-1 text-xs text-[#ddd] hover:bg-[#242424]"><Edit size={11} /> Edit</button>
